...
def blocktest(s):
    ...
    for t in Tenpai.getTenpai(s):
        print(Block.getBlocks(TenpaiTest.toTile(s), t, Agari.by_int(32)))
        for b in Block.getBlocks(TenpaiTest.toTile(s), t, Agari.by_int(32)):
            print(b)
...
print(Category.CHUNCHANHAI.value)
